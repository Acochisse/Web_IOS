  ...
  return (
    <div className="App">
      ...
      <DataContext.Provider value={{ data: {} }}>
          <WebSocketProvider url="ws://192.168.1.143:3030/update_value_ws" context={UpdateValueWebSocketContext}>
            <WebSocketProvider url="ws://192.168.1.143:3030/change_value_ws" context={ChangeValueWebSocketContext}>
              <TopBar />
